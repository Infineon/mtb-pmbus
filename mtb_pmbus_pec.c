/***************************************************************************//**
* \file mtb_pmbus_pec.c
* \version 1.0
*
* Provides PEC calculation function.
*
********************************************************************************
* \copyright
...
/**
 * \brief Updates the CRC-8 value with a new byte using a precomputed lookup table.
 *
 * \param current_crc The current CRC-8 value.
...
{
    /*******************************************************************************
    * Pre-computed CRC-8 data using polynomial 0x07 (x^8 + x^2 + x + 1) and initial value 0x00.
    * Each byte represents the CRC-8 value for the given index.
    * For example, the CRC-8 computation for 0x80 is 0x89 (i.e. crc_table[0x80] yields 0x89).
    *******************************************************************************/
