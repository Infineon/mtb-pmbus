...
uint16_t mtb_pmbus_float_to_lin11(float32_t float_var)
{
    ...
    else
    {
        ...
        mantissa = (uint16_t)(((var_32 >> MTB_PMBUS_LIN11_FLOAT_10MSB_MAN_SHIFT) & MTB_PMBUS_LIN11_FLOAT_10MSB_MAN_MASK) | MTB_PMBUS_LIN11_FLOAT_10MSB_MAN_LEAD);
        ...
        /* If exponent is < -16, increase it to avoid exceeding 5-bit signed minimum by right-shifting mantissa */
